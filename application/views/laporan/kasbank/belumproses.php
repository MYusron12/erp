        ...
        <div class="container-fluid">
          ...
          <div class="row">
          	<form class="form-inline"  action="<?= base_url('laporan/belumprosesho'); ?>" method="post">
          ...
          <a href="#" class="btn btn-primary btn-sm mt-3" id="ctkbelumprosesho" name="ctkbelumprosesho" data-toggle="modal" data-target="#cetakBelumProsesHoModal">Cetak</a>
  ...
  <!-- Modal -->
<div class="modal fade" id="cetakBelumProsesHoModal" tabindex="-1" role="dialog" aria-labelledby="cetakBelumProsesHoModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="cetakBelumProsesHoModalLabel">Cetak</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="<?= base_url('report/belumprosesho') ?>" method="post" target="_blank">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="yabelumprosesho">Ya</button>
      </div>
    </div>
    </form>
  </div>
