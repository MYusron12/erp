        ...
        <div class="container-fluid">
          ...
          <div class="row">
          	<form class="form-inline"  action="<?= base_url('laporan/reimburstkasbank'); ?>" method="post">
          ...
          <a href="#" class="btn btn-primary btn-sm mt-3" id="ctkreimburst" name="ctkreimburst" data-toggle="modal" data-target="#cetakReimburstModal">Cetak</a>
  ...
  <!-- Modal -->
<div class="modal fade" id="cetakReimburstModal" tabindex="-1" role="dialog" aria-labelledby="cetakReimburstModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="cetakReimburstModalLabel">Cetak Reimburstment Kasbank</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="<?= base_url('report/reimburst') ?>" method="post" target="_blank">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="yareimburst">Ya</button>
      </div>
    </div>
    </form>
  </div>
