        ...
        <div class="container-fluid">
          ...
          <div class="row">
          	<form class="form-inline"  action="<?= base_url('laporan/oskbbelumrealisasiho'); ?>" method="post">
          ...
          <a href="#" class="btn btn-primary btn-sm mt-3" id="ctkkasbankhobelumrealisasi" name="ctkkasbankhobelumrealisasi" data-toggle="modal" data-target="#cetakKasbankhoBelumRealHoModal">Cetak</a>
          ...
          <div class="row">
              ...
              <?php $start_date = new DateTime($row['tgl_pengajuan']); ?>
					  	<?php $end_date = new DateTime($row['tgl_proses']); ?>
  ...
  <!-- Modal -->
<div class="modal fade" id="cetakKasbankhoBelumRealHoModal" tabindex="-1" role="dialog" aria-labelledby="cetakKasbankhoBelumRealHoModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="cetakKasbankhoBelumRealHoModalLabel">Cetak</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="<?= base_url('report/kasbankhobelumrealisasi') ?>" method="post" target="_blank">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="yakasbankhobelumreal">Ya</button>
      </div>
    </div>
    </form>
  </div>
