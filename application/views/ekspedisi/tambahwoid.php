        ...
        <div class="col-lg-6">
            ...
            <form action="" method="post">
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="no_pengerjaan" name="no_pengerjaan" value="<?= $no;?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                               ...
                               <select id="eccmb" class="selectpicker form-control" name="id_truck" data-style="btn-success">
                 ...
                 <div class="form-group row">
                    <label for="pendidikan" class="col-sm-2 col-form-label">Categori </label>
                    <div class="col-sm-5">
                        <select class="form-control" name="categori" id="pendidikan">
                            <option value="">Pilih</option>
                            <?php foreach ($categori as $row) : ?>
                                <option value="<?= $row; ?>" <?= set_select('categori', $row); ?>><?= $row; ?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label for="alamat" class="col-sm-2 col-form-label">Nama Supir</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="deskripsi_peminta" name="deskripsi_supir">
                    </div>
                </div>
                <div class="form-group row">
