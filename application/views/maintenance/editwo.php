    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control tanggal" id="tanggal_cek" name="tanggal_cek"  autocomplete="off" value="<?= $wo->tanggal_cek;?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="sim1" class="col-sm-3 col-form-label">pic_cek</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="pic_cek" name="pic_cek" value="<?= $wo->pic_cek;?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="masaberlaku1" class=" col-sm-3 col-form-label">Komponen yang di ganti</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="deskripsi_perkerja" name="deskripsi_komponen"  autocomplete="off" value="<?= $wo->deskripsi_komponen;?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="masaberlaku1" class=" col-sm-3 col-form-label">deskripsi_perkerja</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="deskripsi_perkerja" name="deskripsi_perkerja"  autocomplete="off" value="<?= $wo->deskripsi_perkerja;?>">
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="form-group row mt-5">
                <div class="col-sm-10">
                    ...
                    <a href="<?= base_url('maintenance/workorder'); ?>" class="btn btn-danger"><i class="fas fa-times"></i>Cancel</a>
                </div>
                </form>
            </div>
        </div>
