        ...
        <div class="row">
          ...
          <?php if($transaksi['trans']['status'] == 2) :  ?>
        ...
        <div class="row">
          <div class="col-md-6"> 
            ...
            <div class="form-check form-check-inline">
              ...
              <div class="form-check form-check-inline">
                <input type="radio" name="pilihan" id="inlineRadio2" value="KAS" onclick="validasi_radio();" checked>
          ...
          <div class="form-group row">
           ...
           <div class="form-group row mt-5">
            ...
            <div class="col-sm-6">
              <select  id="nomorbs" name="nomorbs[]" class="selectpicker form-control" data-style="btn-primary" data-live-search="true" data-width="fit" multiple disabled>
               ...
               <?php foreach ($bspusat as $row) : ?>
                <option value="<?= $row['idbskantorpusat']; ?>"><?= $row['nobs']."-". $row['pemohon']; ?></option>
                <?php endforeach; ?> 
              </select> 
            </div>
          </div>
           ...
           <div class="form-group row">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" id="jmlterpakaiawal" name="jmlterpakaiawal" autocomplete="off" value="<?= number_format($total['jumlah']); ?>" readonly >
            </div>
          </div>
            ...
            <div class="row mt-1">
             <div class="col-md-3">
                ...
                <div class="col-sm-10 mt-1">
                  <div class="form-check">
                    <input class="form-check-input1" type="checkbox" id="ckho" name="ckho" autocomplete="off" checked <?= $nonaktif; ?>>
             ...
             <div class="col-md-3">
               <div class="form-group row">
                ...
                <div class="col-sm-6" <?= $nonaktif; ?>>
                  <input type="text" class="form-control tanggal" id="dateho" name="dateho" autocomplete="off" value="<?= date('d-m-Y', strtotime($transaksi['trans']['tgl_proses'])); ?>" <?= $nonaktif; ?>>
                </div>
             </div>
           </div>
      ...
      <hr>
             ...
             <?php if ($transaksi['trans']['tgl_penerima'] == '0000-00-00'): ?>
              <?php $tglterima = " "; ?>
              <?php else : ?>
               <?php $tglterima = date('d-m-Y', strtotime($transaksi['trans']['tgl_penerima'])); ?>
             <?php endif ?>
              ...
              <div class="col-md">
                ...
                <div class="form-row">
                  ...
                  <input type="text" class="form-control" id="batchno" name="batchno" value="<?= $transaksi['trans']['no_batch']; ?>" autocomplete="off" <?= $nonaktif; ?>>
                </div>

                <div class="form-group col-md-2">
                  <label for="datetrans">Date</label>
                  <input type="text" class="form-control tanggal" id="dtpenerima" value="<?= $tglterima; ?>" name="dtpenerima" autocomplete="off" <?= $nonaktif; ?>>
                </div>

                <div class="form-group col-md-2">
                  <label for="nobpkb">BPK/B No</label>
                  <input type="text" class="form-control" id="nobpkb" name="nobpkb" value="<?= $transaksi['trans']['no_bpk']; ?>"  autocomplete="off" <?= $nonaktif; ?>>
                </div>

                <div class="form-group col-md-2">
                  <label for="chequeno">No Giro</label>
                  <input type="text" class="form-control" id="chequeno" name="chequeno" value="<?= $transaksi['trans']['no_giro']; ?>" autocomplete="off" <?= $nonaktif; ?>>
                </div>
