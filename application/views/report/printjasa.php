    ...
    <table class="tg" style="table-layout: fixed; width: 765px">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="tg-zv4m" style="border-right-color: black; border-bottom-color: black; padding: 200px 5px;" colspan="3"><?= $jasa->item_3; ?></td>
            ...
            <tr>
                <td class="tg-aw21" colspan="5">(<?= $user['name']; ?>)<p></br><i>Note : *See table of Capex/Opex Authorization Matrix</i></p></td>
                <td class="tg-aw21" colspan="6">(<?= $jasa->kepala_bagian; ?>)</td>
