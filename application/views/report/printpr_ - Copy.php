    ...
    <table class="tg" style="table-layout: fixed; width: 765px">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="tg-zv4m"></td>
                <td class="tg-km2t"></td>
                <td class="tg-km2t" colspan="5">No. PR : <?= $permintaan['headerpermintaan']->no_permintaan; ?></td>
            </tr>
            <tr>
                <td class="tg-zv4m"></td>
                ...
                <td class="tg-km2t" colspan="4">: <?= $permintaan['headerpermintaan']->budget; ?></td>
            </tr>
            <tr>
                <td class="tg-zv4m"></td>
                <td class="tg-km2t" colspan="4">FROM</td>
                <td class="tg-km2t" colspan="2">: <?= $permintaan['headerpermintaan']->nama_bagian; ?></td>
                <td class="tg-km2t"></td>
                <td class="tg-km2t"></td>
                <td class="tg-km2t"></td>
            ...
            <tr>
                ...
                <td class="tg-km2t">: <?= date('d-m-Y', strtotime($permintaan['headerpermintaan']->tanggal_minta)); ?></td>
                <td class="tg-km2t"></td>
                <td class="tg-km2t"></td>
                <td class="tg-km2t"></td>
                <td class="tg-km2t"></td>
                <td class="tg-km2t" colspan="2">CODING</td>
                <td class="tg-km2t" colspan="4">: <?= $permintaan['headerpermintaan']->coding; ?></td>
            </tr>
            <tr>
                <td class="tg-zv4m"></td>
                <td class="tg-km2t" colspan="4">DELIVERY PERIOD</td>
                <td class="tg-km2t">: <?= date('Y', strtotime($permintaan['headerpermintaan']->tanggal_minta)); ?></td>
                <td class="tg-km2t"></td>
                <td class="tg-km2t"></td>
                <td class="tg-km2t"></td>
                <td class="tg-zv4m"></td>
            ...
            <tr>
                <td class="tg-mqa1" colspan="2">USD / IDR</td>
                <td class="tg-mqa1" colspan="4">USD / IDR</td>
            </tr>
            ...
            <tr>
                    ...
                    <td class="tg-zv3m" colspan="3"><?= $value->kode_barang; ?> || <?= $value->nama_barang; ?></td>
                    <td class="tg-zv3m"><?= $value->qty; ?> <?= $value->nama_satuan; ?></td>
                    <td class="tg-zv3m" colspan="2"><?= number_format($value->harga); ?></td>
                    <td class="tg-zv3m" colspan="4"><?= number_format($value->total); ?></td>
                    <td class="tg-zv3m" colspan="2"><?= $permintaan['headerpermintaan']->keterangan;?> </td>
                    <td class="tg-zv3m" colspan="3"></td>
...
endforeach; ?>
            ...
            <tr>
                <td class="tg-zv4m" colspan="5" style="border-top-color:black"></td>
                <td class="tg-c3ow" style="border-top-color:black" colspan="2"><span style="font-weight:bold">TOTAL</span></td>
                <td class="tg-c3ow" colspan="4"><span style="font-weight:bold"><?= number_format($gt); ?></span></td>
                <td class="tg-zv4m" style ="border-top-color:black" colspan="5"></td>
            </tr>
            <tr>
            ...
            <?php if ($permintaan['headerpermintaan']->status = 2) {
                $approve = 'APPROVED';
            } else {
                $approve = 'WAITING';
            }?>
            ...
            <tr>
                <td class="tg-aw21" colspan="5">(<?= $permintaan['headerpermintaan']->nama_request; ?>)</td>
                <td class="tg-aw21" colspan="6">(<?= $permintaan['headerpermintaan']->kepala_bagian; ?>)(Doni Petra Roosadi)</td>
