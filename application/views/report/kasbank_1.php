    ...
    <table class="table" style="font-size: 9px; line-height: 8px;">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td colspan="2" style="line-height: 25px; border-right: 1px solid #999; text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;IDR &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?= number_format($row['nominal']); ?></td>
        ...
        <tr>
          ...
          <tr>
          <td  colspan="2" style="text-align: center; font-weight: bold; line-height: 20px; border-bottom: 1px solid #999;">Catatan</td>
          <td colspan="2" style="border-bottom: 1px solid #999; line-height: 15px; padding: 5px;"> <?= substr($catatan,0,16); ?> <br> <?= substr($catatan,17,200); ?> </td>
