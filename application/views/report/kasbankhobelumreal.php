...
<head>
  <meta charset="UTF-8">
  <title>Laporan Kas Bank Ke Ho belum Realisasi</title>
...
<body>
 ...
 <?php endif ?>
  ...
  <tr>
    <td><b>LAPORAN KASBANK KE HO BELUM REALISASI</b></td> 
  </tr>
  <tr>
  ...
  <tbody>
       <?php $i=1; $total = 0; foreach ($kasbank as $row) : ?>
              ...
              <?php $interval = $start_date->diff($end_date); ?>
                     ...
                     <tr>
                      <td class="tg" colspan="8" style="text-align: center; font-weight: bold;">TOTAL</td>
