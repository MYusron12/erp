        ...
        <table class="tg" style="table-layout: fixed; width: 765px">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="tg-km2t">:
                        <?= date('d-m-Y', strtotime($permintaan['headerpermintaan']->tanggal_minta)) ?></td>
                    <td class="tg-km2t"></td>
                    <td class="tg-km2t"></td>
                    <td class="tg-km2t"></td>
                    <td class="tg-km2t"></td>
                ...
                <tr>
                    ...
                    <td class="tg-km2t">: <?= date('Y', strtotime($permintaan['headerpermintaan']->tanggal_minta)); ?>
                    </td>
                    <td class="tg-km2t"></td>
                    <td class="tg-km2t"></td>
                    <td class="tg-km2t"></td>
                ...
                <tr class="tr">
                    ...
                    <td class="tg-zv4m" style="border-right-color: black; border-top-color: white" colspan="3">
                        <?= $value->kode_barang; ?> || <?= $value->nama_barang; ?></td>
					...
					<?php if($permintaan['headerpermintaan']->keterangan <= $i) : ?>
                    <td class="tg-zv4m" style="border-right-color: black; border-top-color: white" colspan="2">
                        <?= $permintaan['headerpermintaan']->keterangan; ?></td>
						<?php else : ?>
					<?= " "; ?>	
						<?php endif; ?>	
                ...
                <tr>
                    <td class="tg-aw21" colspan="5">(<?= $permintaan['headerpermintaan']->nama_request; ?>)
                    </td>
                    <td class="tg-aw21" colspan="6">(<?= $permintaan['headerpermintaan']->kepala_bagian; ?>)</td>
